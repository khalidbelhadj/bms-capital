  ...
  return (
    <Main>
      <div className="max-w-screen-md flex flex-col gap-5 [&_p]:mb-4 [&_li]:list-disc [&_li]:ml-10">
        ...
        <div>
          <p>Welcome to Bruce Malhotra Szeszko Capital!</p>
          <p>
          ...
          <p>
            ...
            conditions. Do not continue to use Bruce Malhotra Szeszko Capital if
          ...
          <p>
            ...
            By accessing Bruce Malhotra Szeszko Capital, you agreed to use the
            required cookies.
          </p>
          <p>
          ...
          <h2>License:</h2>
          <p>
            Unless otherwise stated, Bruce Malhotra Szeszko Capital LLP and/or
            its licensors own the intellectual property rights for all material
            on Bruce Malhotra Szeszko Capital. All intellectual property rights
            are reserved. You may access this from Bruce Malhotra Szeszko
            Capital for your own personal use subjected to restrictions set in
          ...
          <ul>
            <li>
              <p>
                Copy or republish material from Bruce Malhotra Szeszko Capital
              </p>
            </li>
            <li>
              <p>
                Sell, rent, or sub-license material from Bruce Malhotra Szeszko
                Capital
              </p>
            </li>
            <li>
              <p>
                Reproduce, duplicate or copy material from Bruce Malhotra
                Szeszko Capital
              </p>
            </li>
            <li>
              <p>Redistribute content from Bruce Malhotra Szeszko Capital</p>
            </li>
          </ul>
          ...
          <p>
            ...
            Bruce Malhotra Szeszko Capital LLP does not filter, edit, publish or
            review Comments before their presence on the website. Comments do
            not reflect the views and opinions of Bruce Malhotra Szeszko Capital
            LLP, its agents, and/or affiliates. Comments reflect the views and
            opinions of the person who posts their views and opinions. To the
            extent permitted by applicable laws, Bruce Malhotra Szeszko Capital
            LLP shall not be liable for the Comments or any liability, damages,
            or expenses caused and/or suffered as a result of any use of and/or
            posting of and/or appearance of the Comments on this website.
          </p>
          <p>
            Bruce Malhotra Szeszko Capital LLP reserves the right to monitor all
          ...
          <p>
            You hereby grant Bruce Malhotra Szeszko Capital LLP a non-exclusive
          ...
          <p>
            ...
            visibility of the hyperlink compensates the absence of Bruce
            Malhotra Szeszko Capital LLP; and (d) the link is in the context of
          ...
          <p>
            ...
            sending an e-mail to Bruce Malhotra Szeszko Capital LLP. Please
          ...
          <p>
            No use of Bruce Malhotra Szeszko Capital LLP&apos;s logo or other
